...
public class Interfáz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Análizador Léxico Versión Código");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jScrollPane1.setViewportView(jTextArea1);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CODIGO/Imagen1.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            List<Main.TokenInfo> tokens = Main.analizarTextoCompleto(textoActual);

            // 3. Mostrar solo los resultados del análisis actual
            Main.generarReporteEnPane(tokens, jTextPane1);
